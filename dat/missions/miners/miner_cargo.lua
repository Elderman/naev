...
Travel distance: %d]]
	...
	cargo_land_p1[4] = "The big bags of "
	...
	cargo_land_p2[3] = " are removed from you cargo hold and leave a large void. As everything is unloaded, you receive your pay as agreed upon."
...
function create()
	...
	cargo = "Ore" -- Transporting from miner bases, so they will be exporting mostly Ore (or other mining materials in the future?)
